...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from 'depin-dex-sdk-core'
import { abi } from 'depin-dex-swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from 'depin-dex-v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
